...
return array(
	...
	//邮件签名落款
	'MAIL_SIGN' => '<sign><p><br/>(^▽^)祝你开心哦！</p><p align="right" style="margin-right:3em"><b>云小印(●\'◡\'●)</b>代表云印团队敬上</p><div style="color:gray"><hr><div style="padding-left:1em"><div align="left" style="line-height:1.66;font-size:.9em;display:inline-block"><div>官方主页：<span style="color:gray">www.yunyin.org</span></div><div>官方微博：<span style="color:gray">@云印南天</span>（CloudPrint）</div><div>人人主页：<span style="color:gray">@云印南天</span></div><span>微信账号：云印南天（YunYinNanTian）</span></div></div></div></sign>',
